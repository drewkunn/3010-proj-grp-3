...
* **Database Migration**: 
    * [cite_start]Exported the original database structure and data using `pg_dumpall`[cite: 41].
...
* **FTE Feature**: 
    * [cite_start]Implemented a new **FTE (Full-Time Equivalent)** tab on the dashboard[cite: 28].
    * [cite_start]Developed Python objects and methods within `webpages/fte.py` to calculate and display faculty FTE values based on database records[cite: 29].
* **Independence Verification**: 
    * [cite_start]Confirmed the Web-VM's self-sufficiency by powering off the Main-VM and original PGSQL-VM[cite: 5].
...
* **Project Structure**:
    * [cite_start]`DB/`: Contains the `pg_dumpall` SQL backup and configuration files[cite: 41].
    * [cite_start]`webpages/`: Contains all web development files and the new FTE logic[cite: 42].
    * [cite_start]`Dockerfile`: The configuration file used to build the database container[cite: 31].
